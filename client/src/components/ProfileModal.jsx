            ...
            <form className='space-y-4' onSubmit={e=> toast.promise(handleSaveProfile(e), {loading: 'Saving...'})}>
                    ...
                    <div className='flex flex-col items-start gap-3 '>
                        <label htmlFor="profile_picture" className='block text-sm font-medium text-gray-700 mb-1 '>
                                Profile Picture
                                <input hidden onChange={(e) => setEditForm({...editForm, profile_picture: e.target.files[0]})} type="file" id='profile_picture' accept='image/*' className='w-full p-3 border border-gray-200 rounded-lg' />
                    ...
                    <div className='flex flex-col items-start gap-3'>
                        <label htmlFor="cover_photo" className='block text-sm font-medium text-gray-700 mb-1'>
                            Cover Photo
                              <input hidden onChange={(e) => setEditForm({...editForm, cover_photo: e.target.files[0]})} type="file" id='cover_photo' accept='image/*' className='w-full p-3 border border-gray-200 rounded-lg' />
                    ...
                    <div className='flex justify-end space-x-3 pt-6 '>
                            ...
                            <button onClick={()=> setShowEdit(false)} type='button' className='px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors cursor-pointer active:scale-95'>Cancel</button>

                            <button type='submit' className='bg-gradient-to-br from-indigo-500 to-purple-600 hover:from-indigo-700 hover:to-purple-800 active:scale-95 cursor-pointer text-white p-2 rounded-lg px-4 py-2'>Save Changes</button>
                    </div>
            </form>
