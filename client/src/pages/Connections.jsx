                        ...
                        <div className="flex max-sm:flex-col gap-2 mt-4 ">
                          ...
                          }
                          {
                            currenttab === 'Following' && (
                              <button onClick={()=> handleUnfollow(user._id)} className="w-full text-sm rounded bg-slate-100 hover:bg-slate-200 text-black active:scale-95 transition cursor-pointer">
                                Unfollow
                              </button>
                            )
                          }
                          {
                            currenttab === 'Pending' && (
                              <button onClick={()=> acceptConnection(user._id)} className="w-full text-sm rounded bg-slate-100 hover:bg-slate-200 text-black active:scale-95 transition cursor-pointer">
                               Accept
                              </button>
                            )
                          }
